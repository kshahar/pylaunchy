...
if(GTEST_INCLUDE_DIRS AND GTEST_LIBRARIES AND GTEST_MAIN_LIBRARIES)
  ...
  if (NOT GTEST_PREFIX AND NOT $ENV{GTEST_ROOT} STREQUAL "")
    set(GTEST_PREFIX $ENV{GTEST_ROOT})
  endif(NOT GTEST_PREFIX AND NOT $ENV{GTEST_ROOT} STREQUAL "")  
  ...
  if(GTEST_PREFIX)
    ...
    #  PATHS "${GTEST_PREFIX}/include"
      #PATH_SUFFIXES "gtest"
    #  NO_DEFAULT_PATH)
    set(_GTEST_INCLUDE_DIR "${GTEST_PREFIX}/include" )
